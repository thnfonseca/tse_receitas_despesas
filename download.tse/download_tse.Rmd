...
Antes de baixar os dados, selecionamos o diretório em que os bancos serão baixados. No caso, baixaremos na pasta do nosso projeto, [`tse_receitas_despesas`](https://github.com/thnfonseca/tse_receitas_despesas). Dentro desta pasta, os bancos serão divididos em outras pastas que correspondem ao ano eleitoral da despesa e da receita. O conteúdo dos bancos não estão disponíveis no GitHub, porque os arquivos superam o espaço disponível. No entanto, para replicar o trabalho basta definir um diretório no seu computador.
